          ...
          <div class="listboard">
            <Link to="/gtholidays" class="card" data-grid-index="1">
              <div class="card-video-inner">
                <img src={pic1} alt="GT Holidays cover" loading="lazy" />
              </div>
            ...
            <Link to="/gtholidays" class="card" data-grid-index="4">
              <div class="card-video-inner">
                <img src={pic4} alt="Akshaya Catering cover" loading="lazy" />
              </div>
            ...
            <Link to="/harrisnadar" class="card" data-grid-index="5">
              <div class="card-video-inner">
                <img src={pic5} alt="Delano Residency cover" loading="lazy" />
              </div>
            ...
            <Link to="/tinoengineering" class="card" data-grid-index="6">
              <div class="card-video-inner">
                <img src={pic6} alt="At Broadband cover" loading="lazy" />
              </div>
            ...
            <Link to="/harrisnadar" class="card" data-grid-index="8">
              <div class="card-video-inner">
                <img src={pic8} alt="Fuji Otis Monarch cover" loading="lazy" />
              </div>

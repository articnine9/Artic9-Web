...
import Abtgt from "../../../Assets/case-study/gt-holidays/about-gt.webp";
import Id1 from "../../../Assets/case-study/gt-holidays/identity-img.webp";
import Id2 from "../../../Assets/case-study/gt-holidays/identity-img2.webp";
import Insta1 from "../../../Assets/case-study/gt-holidays/instagram01.webp";
import Insta2 from "../../../Assets/case-study/gt-holidays/instagram02.webp";
import Insta3 from "../../../Assets/case-study/gt-holidays/instagram03.webp";
...
const Gt = () => {
  return (
    <div className="gt">
        ...
        <div className="container">
          <div className="about-content-wrapper-4">
            <div className="row">
              ...
              {/* Text Section */}
              <div className="col-lg-6 abtout-text">
                <div className="about-text-wrapper">
                  <div className="section-title title-border gradiant-border headline gt-abt-cnt-head">
                    <h2 style={{ color: "black" }}>About GT Holidays</h2>
                  </div>
      ...
      <section id="blog" className="blog-section-3 service-page-blog gt-section">
        <div className="container">
          <div className="section-title text-center headline blog-section-3 gt-sec-cnt">
